...
public class MQTTServiceSubscribe extends Service implements MqttCallback {
    ...
    private final String REPORT = "Subscribe_LOG";
    ...
    private short keepAliveSeconds = 5;
    ...
    public void onCreate() {
        ...
        mBinder = new LocalBinder<MQTTServiceSubscribe>(this);
    ...
    synchronized void handleStart(Intent intent, int startId) {
        ...
        if (isAlreadyConnected() == false) {
            ...
            Notification.Builder builder = new Notification.Builder(MQTTServiceSubscribe.this);
            ...
            if (isOnline()) {
                ...
                if (connectToBroker()) {
                    Log.e(REPORT, "01: subscribe to start");
    ...
    private LocalBinder<MQTTServiceSubscribe> mBinder;
...
//            mqttClient.connect(generateClientId(), cleanStart, keepAliveSeconds);
            ...
            mqttClient.connect(options, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken iMqttToken) {
                    subscribeToTopic(topicName);
                    Log.e(REPORT, "02: subscribe on success of connectedToBroker");
                    //
    ...
    private void subscribeToTopic(String topicName) {
        ...
        if (isAlreadyConnected() == false) {
            ...
            try {
                ...
                subscribed = true;
                if((firstTime==false)&&(subscribed==true)){
                    firstTime = true;
                }

                Log.e(REPORT, "06: subscribeToTopic succeed");
                if(firstTime){
                    notifyUser("Subscribe pending", "MQTT", "Currently no information of "+topicName);
                    firstTime = false;
                }
            }
    ...
    private class NetworkConnectionIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            if (isOnline()) {
                ...
                if (connectToBroker()) {
                    Log.e(REPORT, "03: subscribe on receive of wake lock");
                    // we subscribe to a topic - registering to receive push
                    //  notifications with a particular key
                    subscribeToTopic(topicName);
                }
    ...
    public class PingSender extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try
            {
                ...
                mqttClient.publish("keepAlive", message);
            }
            catch (MqttException e)
            {
